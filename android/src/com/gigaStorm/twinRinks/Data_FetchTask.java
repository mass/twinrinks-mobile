		...
		try {
	        ...
	        for (Element src : elems) {
	        	...
	        	if (line.length() > 60 )
	        	{
	            	...
	            	// Check if the date Jan 1st. According to Gary Pivar (owner), there will
	            	// never be a game on that day because it's a customer appreciation date.
	            	// TODO: add that day to every team in every league as customer appreciation
